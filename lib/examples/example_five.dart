...
//
// Future<Person?> createOrUpdatePersonDialog(BuildContext context, [Person? existingPerson]) async {
...
//                       final oldPerson = existingPerson.updated(name, age);
//                       Navigator.of(context).pop(oldPerson);
//                     } else {
//                       // have not existing person, create a new one
